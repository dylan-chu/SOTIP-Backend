...
public class ProjectInfo {
    ...
    public static final int NULL_SDM = 8;
    ...
    /**
     * Converts the a string representing a project's status to an integer code.
     * 
     * @param status
     * 			the string representing the project's status
     * 
     * @return an integer corresponding to the project's status
     */
    ...
    /**
     * Two values, PM experience level and software development methodology, are given as strings.  At the
     * beginning of the string is a number that can represent the given value.  This function extracts that
     * number from the string value.
     * 
     * @param codeStr
     * 			the string value
     * 
     * @return the integer code at the beginning of the string value
     */
	...
	/**
	 * Checks if a string is null and returns the default string is it is
	 * 
	 * @param str
	 * 			the string to check
	 * 
	 * @return the original string or the default string
	 */
